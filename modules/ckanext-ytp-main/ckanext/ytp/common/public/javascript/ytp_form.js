...
function createRemoveLink(inputContainer) {
    ...
    var removeLink = $('<a href="javascript:void(0);" class="ytp-add-input"><span class="fa fa-minus-square fa-2x"></span></a>');
    ...
    $('.ytp-multiple-values').each(function() {
        ...
        listContainer.children('div').each(function(valueIndex) {
            if (valueIndex == 0) {
                ...
                var addLink = $('<a href="javascript:void(0);" class="ytp-add-input"><span class="fa fa-plus-square fa-2x"></span></a>');
